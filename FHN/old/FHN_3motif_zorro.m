...
% v=Y(1); w=Y(2);
v0=[-0.5; -0.5; -0.5];w0=[0.3 ;0.3005; 0.3007];
a=0.1;d=0.0001;eps=0.009;I0=.2; wsh=0.35;
Y0=[v0;w0];
t=0:0.1:10000;
options=odeset('RelTol',1.e-5);
[T, Y]=ode45(@dydt_FHN,t,Y0,options,a,eps,d,I0,wsh);
...
function val=vrhs_FHN(w,v,a,I0,vsh)
	val=-v*(v-a)*(v-1)-w+I0;
end


function dY=dydt_FHN(t,Y,a,eps,d,I0,wsh)
v(1)=Y(1);
v(2)=Y(2);
v(3)=Y(3);
w(1)=Y(4);
