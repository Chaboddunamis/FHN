...
f = @(t,y) [y(1)-y(1).^3 - y(2) + I-g21*(y(1)+1.5)./(1+exp(-k*(y(3)))); eps*(1/(1+exp(-k2*(y(1)+shift)))-y(2));  y(3)-y(3).^3 - y(4) + I-g12*(y(3)+1.5)./(1+exp(-k*(y(1)))); eps*(1./(1+exp(-k2*(y(3)+shift)))- y(4)) ];
...
[T,Y,tau,Ye,ie] = ode45(f,(0:0.1:26000),[0; 1.10; 1; 0.11],options);
